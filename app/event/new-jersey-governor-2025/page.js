...
export default function NewJerseyGovernor2025() {
  ...
  const EVENT_TITLE = '[보관됨] 2025년 뉴저지주 주지사 선거';
  ...
  useEffect(() => {
    ...
    fetch('/api/event-videos?event=new-jersey-governor-2025&language=korean')
      .then(res => res.json())
      ...
      <div className="bg-gradient-to-r from-orange-50 to-yellow-50 py-4 border-b border-orange-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ 뉴저지 유권자 정보 확인하기</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">뉴저지 주민을 위한 투표 정보 • 등록 확인 • 투표소 찾기 • 중요 일정</p>
        </div>
      </div>
