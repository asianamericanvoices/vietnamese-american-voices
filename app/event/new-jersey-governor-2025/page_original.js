// New Jersey Governor 2025 Event Page - Same layout as homepage, filtered by event
'use client';

import React, { useState, useEffect } from 'react';
import { Clock, ExternalLink, ChevronRight, Globe, TrendingUp, Users, Building2, Flag, MapPin, Heart, GraduationCap, Plane, Palette, Newspaper, Trophy, Stethoscope } from 'lucide-react';
import Link from 'next/link';
import SearchBar from '../../components/SearchBar';
import LocationPopup from '../../components/LocationPopup';

export default function NewJerseyGovernor2025() {
  ...
  const EVENT_NAME = 'New Jersey Governor 2025';
  const EVENT_TITLE = '2025년 뉴저지주 주지사 선거';
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Location-based Popup for New Jersey Users */}
      <LocationPopup state="NJ" eventType="nj-governor" />
        ...
        <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-blue-50 via-green-50 to-purple-50">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
              ...
              <Link
                href="/event/new-jersey-governor-2025"
              ...
              >
                <span>🏛️ 뉴저지 주지사 선거 2025년 11월</span>
              </Link>
              <Link
                href="/event/pennsylvania-supreme-court-2025"
              ...
              >
                <span>⚖️ 펜실베이니아 대법원 재임용 선거</span>
              </Link>
              <Link
                href="/event/georgia-psc-2025"
              ...
              >
                <span>⚡ 조지아 주 공공서비스 위원회 선거</span>
              </Link>
              <Link
                href="/event/california-redistricting-2025"
              ...
              >
                <span>📊 캘리포니아 선거구 재조정 제50호 발의안</span>
              </Link>
            </div>
            ...
            <div className="md:hidden flex flex-col items-center space-y-2">
              ...
              <div className="flex flex-col items-center space-y-2 w-full">
                ...
                >
                  <span>📊 캘리포니아 발의안 50 - 선거구 재조정</span>
                </Link>
              </div>
            </div>
          </div>
      ...
      {/* Event Banner - Dynamic Breaking News Ticker with Orange Theme */}
