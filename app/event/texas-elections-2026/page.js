// Texas Elections 2026 Event Page - Same layout as homepage, filtered by event
'use client';
...
export default function TexasElections2026() {
  ...
  const EVENT_TITLE = 'Bầu cử Texas 2026';
  ...
  useEffect(() => {
    ...
    fetch('/api/event-videos?event=texas-elections-2026&language=vietnamese')
      .then(res => res.json())
  ...
  // Find the event hero article or fall back to the first article
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-orange-500 rounded-lg flex flex-col items-center justify-center gap-0.5">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="mailto:contact@tiengnoinguoimygocviet.us" className="text-gray-700 hover:text-orange-600 text-sm font-medium">
                Liên hệ
              </a>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-orange-50 via-orange-50 to-red-50">
            <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-orange-50 py-4 border-b border-orange-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ Thông tin cử tri Texas</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Thông tin bỏ phiếu cho cư dân Texas • Đăng ký • Địa điểm bỏ phiếu • Ngày quan trọng</p>
        </div>
      </div>
              ...
              {featuredArticle && (
                <article className="group cursor-pointer">
                  <a href={getArticleUrl(featuredArticle)} className="block">
                    ...
                    <div className="mt-6">
                      <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight group-hover:text-orange-600 transition-colors font-vietnamese">
                      ...
                      <a href={getArticleUrl(article)} className="block">
                        <div className="flex space-x-3">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-900 group-hover:text-orange-600 transition-colors leading-tight font-vietnamese">
              ...
              <div className="bg-orange-50 rounded-lg p-6">
                ...
                <form onSubmit={handleNewsletterSignup} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    disabled={newsletterStatus === 'loading'}
                    className="w-full bg-orange-600 text-white py-2 rounded-lg text-sm font-medium hover:bg-orange-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              {otherArticles.map((article) => (
                <article key={article.id} className="group cursor-pointer">
                  <a href={getArticleUrl(article)} className="block">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-orange-600 transition-colors leading-tight font-vietnamese mb-2">
                      {getDisplayTitle(article)}
                    </h3>
