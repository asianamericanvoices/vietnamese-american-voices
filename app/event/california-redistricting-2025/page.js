// California Redistricting 2025 Event Page - Same layout as homepage, filtered by event
'use client';
...
export default function CaliforniaRedistricting2025() {
  ...
  const EVENT_NAME = 'California Redistricting 2025';
  const EVENT_TITLE = '[보관됨] 2025년 캘리포니아주 선거구 재획정';
  ...
  useEffect(() => {
    ...
    fetch('/api/event-videos?event=california-redistricting-2025&language=korean')
      .then(res => res.json())
  ...
  return (
    <div className="min-h-screen bg-white">
      <LocationPopup state="CA" eventType="california-redistricting-2025" />

      {/* Manual Voting Info Popup */}
      <ManualVotingInfoPopup
        state="CA"
        eventType="ca-redistricting"
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-50 py-4 border-b border-yellow-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ 캘리포니아 유권자 정보 확인하기</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">캘리포니아 주민을 위한 투표 정보 • 등록 확인 • 투표소 찾기 • 중요 일정</p>
        </div>
      </div>
