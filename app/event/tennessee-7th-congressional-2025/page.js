// Tennessee 7th Congressional District 2025 Event Page - Same layout as homepage, filtered by event
'use client';
...
export default function Tennessee7thCongressional2025() {
  ...
  const EVENT_NAME = 'Tennessee 7th Congressional District 2025';
  const EVENT_TITLE = '테네시 제7선거구 국회 특별선거';
  ...
  useEffect(() => {
    ...
    fetch('/api/event-videos?event=tennessee-7th-congressional-2025&language=korean')
      .then(res => res.json())
  ...
  return (
    <div className="min-h-screen bg-white">
      <LocationPopup state="TN" eventType="tennessee-7th-congressional-2025" />

      {/* Manual Voting Info Popup */}
      <ManualVotingInfoPopup
        state="TN"
        eventType="tennessee-7th-congressional"
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        ...
        <div className="border-t border-gray-200 py-3 bg-gray-100">
          <div className="max-w-7xl mx-auto px-6 text-center">
            <span className="text-sm text-gray-600">
              📁 이 선거 특집은 아카이브되었습니다 - 선거일: 2025년 1월
            </span>
          </div>
        </div>
      </header>
      ...
      <div className="bg-gradient-to-r from-orange-50 to-yellow-50 py-4 border-b border-orange-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <button
            onClick={() => {
              // Track button click
              if (typeof window !== 'undefined' && window.gtag) {
                window.gtag('event', 'voting_info_button_click', {
                  ...
                  event_label: 'tennessee-7th-congressional-2025',
                  state: 'TN'
                });
              }
              // Track internally
              fetch('/api/analytics/track', {
                ...
                body: JSON.stringify({
                  ...
                  metadata: {
                    state: 'TN',
                    event_type: 'tennessee-7th-congressional-2025',
          ...
          >
            ...
            <span className="text-lg">🗳️ 테네시 유권자 정보</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">테네시주 주민을 위한 투표 정보 • 등록 확인 • 투표소 찾기 • 중요 일정</p>
        </div>
      </div>
