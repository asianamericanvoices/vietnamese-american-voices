// Alaska Senate 2026 Event Page - Vietnamese American Voices
'use client';
...
export default function AlaskaSenate2026() {
  ...
  const EVENT_TITLE = 'Bầu cử Thượng viện Alaska 2026';
  ...
  useEffect(() => {
    fetch('/api/event-videos?event=alaska-senate-2026&language=vietnamese')
      .then(res => res.json())
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="mailto:contact@tiengnoinguoimygocviet.us" className="text-gray-700 hover:text-purple-600 text-sm font-medium">
                Liên hệ
              </a>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-purple-50 via-yellow-50 to-red-50">
            <div className="max-w-7xl mx-auto px-6">
              {/* Desktop */}
              <div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
                ...
                >
                  <span>🗳️ Bầu cử Thượng viện Alaska 2026</span>
                </Link>
              </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-yellow-50 py-4 border-b border-purple-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ Thông tin cử tri Alaska</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Thông tin bỏ phiếu cho cư dân Alaska • Đăng ký • Địa điểm bỏ phiếu • Tổng tuyển cử 3/11</p>
        </div>
      </div>
              ...
              {featuredArticle && (
                <article className="group cursor-pointer">
                  <a href={getArticleUrl(featuredArticle)} className="block">
                    ...
                    <div className="mt-6">
                      <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight group-hover:text-purple-600 transition-colors font-vietnamese">
                      ...
                      <a href={getArticleUrl(article)} className="block">
                        <div className="flex space-x-3">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-900 group-hover:text-purple-600 transition-colors leading-tight font-vietnamese">
              ...
              <div className="bg-purple-50 rounded-lg p-6">
                ...
                <form onSubmit={handleNewsletterSignup} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    disabled={newsletterStatus === 'loading'}
                    className="w-full bg-purple-600 text-white py-2 rounded-lg text-sm font-medium hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              {otherArticles.map((article) => (
                <article key={article.id} className="group cursor-pointer">
                  <a href={getArticleUrl(article)} className="block">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-purple-600 transition-colors leading-tight font-vietnamese mb-2">
                      {getDisplayTitle(article)}
                    </h3>
