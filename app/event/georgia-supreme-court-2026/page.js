...
export default function GeorgiaSupremeCourt2026() {
  ...
  const EVENT_TITLE = 'Bầu cử Tòa án Tối cao Georgia 2026';
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="mailto:contact@tiengnoinguoimygocviet.us" className="text-gray-700 hover:text-green-600 text-sm font-medium">
                Liên hệ
              </a>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-yellow-50 py-4 border-b border-green-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ Thông tin cử tri Georgia</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Thông tin bỏ phiếu cho cư dân Georgia • Đăng ký • Địa điểm bỏ phiếu • Ngày quan trọng</p>
        </div>
      </div>
