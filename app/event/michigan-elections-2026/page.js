// Michigan Elections 2026 Event Page - Same layout as homepage, filtered by event
'use client';
...
export default function MichiganElections2026() {
  ...
  const EVENT_TITLE = 'Bầu cử Michigan 2026';
  ...
  useEffect(() => {
    ...
    fetch('/api/event-videos?event=michigan-elections-2026&language=vietnamese')
      .then(res => res.json())
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="mailto:contact@tiengnoinguoimygocviet.us" className="text-gray-700 hover:text-yellow-600 text-sm font-medium">
                Liên hệ
              </a>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-yellow-50 via-yellow-50 to-red-50">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
                ...
                >
                  <span>🗳️ Bầu cử Michigan 2026</span>
                </Link>
              </div>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-50 py-4 border-b border-yellow-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ Thông tin cử tri Michigan</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Thông tin bỏ phiếu cho cư dân Michigan • Đăng ký • Địa điểm bỏ phiếu • Ngày quan trọng</p>
        </div>
      </div>
              ...
              {otherArticles.map((article) => (
                <article key={article.id} className="group cursor-pointer">
                  <a href={getArticleUrl(article)} className="block">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-yellow-600 transition-colors leading-tight font-vietnamese mb-2">
                      {getDisplayTitle(article)}
                    </h3>
