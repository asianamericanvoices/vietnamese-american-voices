// Pennsylvania Supreme Court 2025 Event Page - Same layout as homepage, filtered by event
'use client';
...
export default function PennsylvaniaSupremeCourt2025() {
  ...
  const EVENT_NAME = 'Pennsylvania Supreme Court 2025';
  const EVENT_TITLE = '[보관됨] 2025년 펜실베이니아 대법원 선거';
  ...
  useEffect(() => {
    ...
    fetch('/api/event-videos?event=pennsylvania-supreme-court-2025&language=korean')
      .then(res => res.json())
  ...
  return (
    <div className="min-h-screen bg-white">
      <LocationPopup state="PA" eventType="pennsylvania-supreme-court-2025" />

      {/* Manual Voting Info Popup */}
      <ManualVotingInfoPopup
        state="PA"
        eventType="pa-supreme-court"
      ...
      <div className="bg-gradient-to-r from-purple-50 to-yellow-50 py-4 border-b border-purple-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ 펜실베이니아 유권자 정보 확인하기</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">펜실베이니아 주민을 위한 투표 정보 • 등록 확인 • 투표소 찾기 • 중요 일정</p>
        </div>
      </div>
