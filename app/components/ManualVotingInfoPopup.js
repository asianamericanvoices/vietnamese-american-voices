...
export default function ManualVotingInfoPopup({ state, eventType, isOpen, onClose }) {
  ...
  const getPopupContent = () => {
    const content = {
      ...
      'TN': {
        title: 'Cử tri Tennessee thân mến',
        subtitle: 'Thông tin Bầu cử Đặc biệt Quốc hội Khu vực 7 Tennessee',
        resources: [
          {
            icon: Vote,
            title: 'Kiểm tra đăng ký cử tri',
            ...
            linkText: 'Truy cập TN Voter Lookup'
          },
          {
            icon: FileText,
            title: 'Đăng ký bỏ phiếu vắng mặt',
          ...
          {
            icon: Info,
            title: 'Thông tin bầu cử đặc biệt',
            description: 'Chi tiết về bầu cử đặc biệt Khu vực 7',
            link: 'https://sos.tn.gov/elections/services/special-election-information',
            linkText: 'Thông tin chính thức bầu cử đặc biệt'
          },
          {
            icon: Calendar,
            title: 'Ngày quan trọng',
            description: 'Ngày bầu cử: 2 tháng 12, 2025',
            dates: [
              'Hạn chót đăng ký cử tri: 3 tháng 11, 2025',
              'Bỏ phiếu sớm: 12 tháng 11 - 26 tháng 11, 2025',
              'Hạn chót đăng ký bỏ phiếu vắng mặt: 25 tháng 11, 2025'
            ]
          }
        ],
        footerMessage: 'Bầu cử đặc biệt Khu vực 7 Tennessee sẽ quyết định đại biểu Quốc hội đại diện cho chúng ta tại Washington.'
      },
      'NC': {
