  ...
  return (
    <html lang="vi">
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-NPB4FNW6');
          `}
        </Script>
      ...
      <body className="bg-white font-inter antialiased">
        {/* Google Tag Manager (noscript) - Sunflower Marketing (VAV container) */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NPB4FNW6"
            height="0"
            width="0"
